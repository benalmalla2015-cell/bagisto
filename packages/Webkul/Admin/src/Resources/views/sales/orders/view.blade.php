                    ...
                    <x-slot:content>
                        <div>
                            ...
                            @if ($order->transfer_number)
                                <div class="mt-3 rounded-md border border-amber-200 bg-amber-50 px-3 py-2 dark:border-amber-800 dark:bg-amber-950">
                                    <p class="text-xs font-semibold text-amber-700 dark:text-amber-300">رقم الحوالة</p>
                                    <p class="font-mono text-sm font-bold text-amber-900 dark:text-amber-100">{{ $order->transfer_number }}</p>
                                </div>
                            @endif
